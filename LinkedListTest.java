public class LinkedListTest
{
  public static void main( String [] args )
  {
    ...
    for (int i: new int[] {7,2,5,2,4,2,3,2}){
      numbers.addToFront(i);
     
    }
    System.out.println("number of occurences of 2 is "+numbers.getNumberOfOccurences(2));

    System.out.println(numbers+" before deleting 2");
    numbers.delete(2);

    System.out.println(numbers+" after deleting 2");
